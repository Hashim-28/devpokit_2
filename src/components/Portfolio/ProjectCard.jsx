        ...
        <AnimatePresence>
          {hovered && (
            ...
            >
              ...
              >
                {/* View Project button (visual only now, wrapped by parent Link) */}
                <div
                  className="flex-1 text-center py-2.5 rounded-xl text-xs font-semibold transition-all hover:brightness-110"
                  style={{
                ...
                {project.github && project.github !== '#' ? (
                  ...
                  <span className="px-4 py-2.5 rounded-xl text-xs font-semibold bg-white/[0.04] text-white/30 border border-white/10 cursor-not-allowed">
                    Private
                  </span>
                )}
              </motion.div>
